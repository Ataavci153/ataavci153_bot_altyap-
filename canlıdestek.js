...
exports.run = async (client, message, params) => {
  ...
  var channel = client.channels.find('id', '747474702775353377')
  ...
  .setFooter("60 Saniye içinde geri dönülmezse lütfen iletişime geçin <†ミ RİP/ ) [Evde kal] Ata avcı#2407>")
